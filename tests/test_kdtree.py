...
from snippets.data_structure.kdtree import KdTree, Point
...
class TestKdTree(unittest.TestCase):
    points = list(list(random.randint(1, 1000000)
                       for j in range(3)) for i in range(1000))
    queries = list(list((random.randint(1, 500000), random.randint(
        500001, 1000000)) for j in range(3)) for i in range(1000))
